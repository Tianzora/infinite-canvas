...
export function CanvasNodeHoverToolbar({
    ...
    const toolbarTools = hasImage ? [...baseToolbarTools, ...extraTools, ...nodeToolbarTools].filter((tool) => quickImageToolIdSet.has(tool.id as ImageQuickToolId)) : [...baseToolbarTools, ...extraTools, ...nodeToolbarTools];
