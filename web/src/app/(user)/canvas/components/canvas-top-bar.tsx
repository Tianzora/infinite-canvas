...
import { Bot, Download, Home, Images, Menu, PanelLeftClose, PanelLeftOpen, Plus, Puzzle, Redo2, Trash2, Undo2, Upload } from "lucide-react";
            ...
            <div className="pointer-events-none absolute left-0 right-0 top-0 z-50 flex h-16 items-center justify-between pl-1 pr-4">
                <div className="pointer-events-auto flex min-w-0 items-center gap-2">
                    <Tooltip title={sidePanelOpen ? "收起面板" : "展开面板"}>
                        <button type="button" onClick={toggleSidePanel} aria-label={sidePanelOpen ? "收起面板" : "展开面板"} className="grid size-7 place-items-center rounded-full transition hover:bg-black/5 dark:hover:bg-white/10" style={{ color: theme.node.text }}>
                ...
                <div className="pointer-events-auto flex items-center gap-1.5">
                    ...
                    <Tooltip title="节点插件">
                        <Button type="text" className="!h-10 !w-10 !rounded-xl !p-0" style={{ background: theme.toolbar.panel, color: theme.node.text }} icon={<Puzzle className="size-4" />} onClick={onOpenPlugins} aria-label="节点插件" />
                    </Tooltip>
