...
function initialWidth() {
    ...
    return stored ? Math.min(CANVAS_SIDE_PANEL_MAX_WIDTH, Math.max(CANVAS_SIDE_PANEL_MIN_WIDTH, stored)) : CANVAS_SIDE_PANEL_DEFAULT_WIDTH;
}

function initialOpen() {
    return typeof window === "undefined" || localStorage.getItem(OPEN_KEY) !== "0";
}
